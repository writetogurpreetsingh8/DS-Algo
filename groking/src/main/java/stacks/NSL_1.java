...
public class NSL_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(nearestSmallerToLeft(arr1)));
		
		int arr2[]= {1,3,2,4};
		System.out.println(Arrays.toString(nearestSmallerToLeft(arr2)));
		
		int arr3[]= {1,3,4,2};
		System.out.println(Arrays.toString(nearestSmallerToLeft(arr3)));
		
		int arr4[]= {4,-5,2,10,8};
		System.out.println(Arrays.toString(nearestSmallerToLeft(arr4)));
	}
